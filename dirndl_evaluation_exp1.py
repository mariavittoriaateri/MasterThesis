...
def evaluate_similarity(gold_file, predicted_file):
    ...
    for i, (gold_query, predicted_query) in enumerate(zip(gold_queries, predicted_queries)):
        gold_keywords, gold_arguments, gold_where_columns, gold_where_operators, gold_where_values, gold_nested_query = extract_clause_components(gold_query.strip())
        predicted_keywords, predicted_arguments, predicted_where_columns, predicted_where_operators, predicted_where_values, predicted_nested_query = extract_clause_components(predicted_query.strip())
        ...
        operator_similarity = calculate_similarity(gold_where_operators, predicted_where_operators)
        ...
        operator_ngram_overlap = calculate_ngram_overlap(gold_where_operators, predicted_where_operators)
